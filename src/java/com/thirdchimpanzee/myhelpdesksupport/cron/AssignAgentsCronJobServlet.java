...
public class AssignAgentsCronJobServlet extends HttpServlet {
 private static final Logger _logger = Logger.getLogger(AssignAgentsCronJobServlet.class.getName());
